...
def test_reference_loader_schema_and_aligned_execute(monkeypatch):
  ...
  two_image_mode = schema.inputs[14]
  ...
  prompt_by_order = schema.inputs[15]
  ...
  waveform_pairs = schema.inputs[18]
