...
1. In both Nodes 2.0 and Legacy Canvas, add **Reference Loader** from `media / reference` and confirm the full board renders without console errors.
...
7. Inspect `manifest_json`; it must contain no base64 data or absolute path.
