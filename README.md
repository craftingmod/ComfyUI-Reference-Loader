...
- Optional H3 Timeline Guides panel for Start, End, and up to 32 visual/audio guide rows at 24 fps; guide-only media stays out of ordinary reference outputs
