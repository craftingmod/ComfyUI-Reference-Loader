  ...
  def execute(
    ...
    return io.NodeOutput(
      ReferenceLoaderBundle(
        ...
        h3_resolution_multiple=state.h3_output.resolution_multiple,
        h3_frame_modulo=state.h3_output.frame_modulo,
        h3_frame_remainder=state.h3_output.frame_remainder,
