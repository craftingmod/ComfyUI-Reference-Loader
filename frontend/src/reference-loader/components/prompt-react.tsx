...
export type PromptReactCommandPort = Pick<
  ReferencePromptController,
  | "clear"
  | "toggleView"
  | "copySource"
  ...
  | "setPreset"
  | "handleReactEditorInput"
  | "handleReactEditorKeydown"
  | "handleReactEditorPaste"
  | "handleReactEditorBlur"
  | "applyPromptBodyEdit"
  | "promptSessionScope"
  | "registerPromptBodyEditor"
  | "resolvePromptPartLabel"
  | "resolvePromptPartVisual"
  | "handlePromptBodyTrigger"
  | "validatePromptBodyParts"
  | "parsePromptBodyText"
  | "rawDraftText"
  | "updateRawDraftText"
  | "removeSection"
...
export function createPromptReactActions(controller: PromptReactCommandPort): PromptReactActions {
  return {
...
export class PromptReactBridge implements PromptReactMount {
  ...
  constructor(options: PromptReactOptions) {
    ...
    this.#actions = createPromptReactActions(options.controller)
