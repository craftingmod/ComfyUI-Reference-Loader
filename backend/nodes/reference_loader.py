    ...
    return io.Schema(
      ...
      inputs=[
        ...
        io.Int.Input(
          ...
          socketless=True,
          tooltip=(
            "Total frames generated by the H3 output. The value is forwarded "
            "to the native H3 length input by the Wrapper."
          ),
        ),
        io.Int.Input(
          "h3_fps",
          ...
          socketless=True,
          tooltip=(
            "Frame rate of the H3 output timeline. Current native MiniMax H3 "
            "execution requires 24 FPS."
          ),
        ),
        *reference_image_output_inputs(),
        io.Combo.Input(
